...
class EarthquakeCard extends StatelessWidget {
  ...
  const EarthquakeCard({super.key, required this.earthquake, this.viewModel});
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 13, letterSpacing: 0.5),
                  maxLines: 1,
